...
export default function Edit() {
    ...
    return (
     ...
     <form onSubmit={sendData}>
      <Input id={'username'} errors={errors} type={'text'} value={user.name} name={'name'} title={'user name'} handelData={handelData}/>
      <Input id={'email'} errors={errors} type={'email'} value={user.email} name={'email'} title={'user email'} handelData={handelData} />
      <Input id={'password'} errors={errors} type={'password'} value={user.password}  name={'password'} title={'user password'} handelData={handelData} />
